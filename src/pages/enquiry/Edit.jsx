          ...
          <div className="row">
            <div className="col-sm-12 col-md-12 col-xl-3">
              <div className="form-group">
                <label style={label}>Enquiry No </label>
                <br />
            ...
            <div className="col-sm-12 col-md-12 col-xl-3">
              <div className="form-group">
                <label style={label}>Enquiry Date </label>
                <br />
                <span style={span}>
            ...
            {enquiry.enquiry_course == "Other" && (
              <div className="col-sm-12 col-md-12 col-xl-3">
                <div className="form-group">
                  <label style={label}>Course Other</label>
                  <br />
            ...
            {enquiry.enquiry_source == "Other" && (
              <div className="col-sm-12 col-md-12 col-xl-3">
                <div className="form-group">
                  <label style={label}>Source Other</label>
                  <br />
            ...
            <div className="col-sm-12 col-md-12 col-xl-3">
              <div className="form-group">
                ...
                <br />
                <span style={span}>
                  {enquiry.enquiry_title} {enquiry.enquiry_full_name}
                </span>
              </div>
            </div>
            <div className="col-sm-12 col-md-12 col-xl-3">
            ...
            <div className="col-sm-12 col-md-12 col-xl-3">
              <div className="form-group">
                <label style={label}>City/Country</label>
                <br />
                <span style={span}>
                  {enquiry.enquiry_city} - {enquiry.enquiry_country}
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="row mt-4">
            <div className="col-sm-12 col-md-12 col-xl-12">
              <div className="receiptbuttons" style={{ textAlign: "center" }}>
                ...
                ) : enquiry.enquiry_status == "Student" ? (
                  ""
                ) : (
                  <Button
                    type="submit"
